      ...
      columns: [{
        ...
        // }
        {
          "render": function(data, type, row, meta) {
            switch (row.status) {
              case 'Acceptée':
                return ('<a href="/hotels/' + row.hotel_id + '/reservation/' + row.id + '" class="btn btn-outline-primary get-meme" value="' + row.id + '" style="width:90px;position: inherit;left: 51px;">Détails</a>');
                break;
              case 'Refusée':
                return ('<a href="/hotels/' + row.hotel_id + '/reservation/' + row.id + '" class="btn btn-outline-primary get-meme" value="' + row.id + '" style="width:90px;position: inherit;left: 51px;">Détails</a>');
                break;
